...
ALTER TABLE public.calculations ADD COLUMN IF NOT EXISTS engineer_verified BOOLEAN DEFAULT false;
ALTER TABLE public.calculations ADD COLUMN IF NOT EXISTS engineer_name TEXT;
ALTER TABLE public.calculations ADD COLUMN IF NOT EXISTS engineer_license TEXT;
ALTER TABLE public.calculations ADD COLUMN IF NOT EXISTS engineer_state TEXT;
ALTER TABLE public.calculations ADD COLUMN IF NOT EXISTS verification_date TIMESTAMP WITH TIME ZONE;