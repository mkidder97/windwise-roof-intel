                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="engineer1@company.com, engineer2@company.com" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
        ...
        <CardContent className="p-0">
            ...
            <TableBody>
              {configs.map((config) => (
                <TableRow key={config.id}>
                  <TableCell>
                    <div>
                      <div className="font-medium">{config.manufacturer_name}</div>
                  ...
                  <TableCell>
                    {config.last_change_detected ? (
                      <Badge variant="outline" className="bg-warning/10">
                        ...
                        {new Date(config.last_change_detected).toLocaleDateString()}
                      </Badge>
                    ) : (
                      <Badge variant="outline" className="bg-success/10">
          ...
          {configs.length === 0 && !isLoading && (
            <div className="p-8 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">No Monitoring Configured</h3>
              <p className="text-muted-foreground">
                Add manufacturer websites to monitor for product and specification changes.
              </p>
            </div>
          )}
        </CardContent>
